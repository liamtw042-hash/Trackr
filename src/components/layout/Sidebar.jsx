...
const NAV_ITEMS = [
  ...
  },
  {
    ...
    icon: (
      <svg className="w-4.5 h-4.5" viewBox="0 0 20 20" fill="currentColor">
        <path fillRule="evenodd" d="M6 2a2 2 0 00-2 2v12a2 2 0 002 2h8a2 2 0 002-2V7.414A2 2 0 0015.414 6L12 2.586A2 2 0 0010.586 2H6zm2 10a1 1 0 10-2 0v3a1 1 0 102 0v-3zm4-1a1 1 0 011 1v3a1 1 0 11-2 0v-3a1 1 0 011-1zm-2-8.586L13.414 6H10V3.414z" clipRule="evenodd" />
      </svg>
    ),
  },
  {
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-3 px-4 py-5 border-b border-white/5">
        ...
        <button
          onClick={onToggle}
          className="ml-auto text-white/30 hover:text-white/70 transition-colors p-1"
        >
      ...
      {/* Account balance */}
      {!collapsed && userProfile?.accountBalance && (
        <div className="px-3 py-2 mx-2 mb-2 rounded-lg bg-white/3 border border-white/5">
